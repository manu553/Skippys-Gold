...
#### Step 1:
On your Android device, navigate over to Settings -> Security and under "Device Administration" make sure the "Unknown sources" is allowed.
...
## Development Team
This game was created by a group of 5 members for a projects course at British Columbia Institute of Technology (BCIT). The theme of the project was to create a brain game that works with touch controls. Skippy's Gold was developed using Unity3D gaming engine over the course of 4 weeks. Development was in an agile approach using Scrum.
